      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold">Shopella</h3>
            <p className="text-gray-400">
              Shop smarter, pay flexibly. Access instant wallet loans and buy now, pay later for everything you need.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/access-loans" className="text-gray-400 hover:text-white">
                  Access Loans
                </Link>
              </li>
              <li>
